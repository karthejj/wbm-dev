...
public class MaterialController {
	...
	public MaterialDTO saveMaterial(@Valid @RequestBody MaterialDTO material) throws DuplicateMaterialException {
		LOGGER.debug("Inside saveMarterial method of MaterialController ");
		return materialService.saveMaterial(material);
	}
	
	@GetMapping("/material/materialList/{sortParam}/{order}")
	public List<MaterialDTO> fetchMaterialList(@PathVariable("sortParam")String sortParam, 
	...
	public MaterialDTO getMaterial(@PathVariable("materialId")long materialId) {
